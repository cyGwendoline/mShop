...
function insert_order($order_details) {
    ...
    $query="select customered from customers WHERE name='".$name."' and address='".$address."' and city='".$city."' and state='".$state."' and zip='".$zip."' and country='".$country."'";
